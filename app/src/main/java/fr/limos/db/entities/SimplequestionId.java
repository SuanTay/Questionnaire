...
/**
 * SimplequestionId generated by hbm2java
 */
@Embeddable
public class SimplequestionId implements java.io.Serializable {

	private int fkIdQuestion;
	private int fkIdSection;
	private int fkIdSurvey;

	public SimplequestionId() {
	}

	public SimplequestionId(int fkIdQuestion, int fkIdSection, int fkIdSurvey) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SimplequestionId))
			return false;
		SimplequestionId castOther = (SimplequestionId) other;
