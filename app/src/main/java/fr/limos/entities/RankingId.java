...
/**
 * RankingId generated by hbm2java
 */
@Embeddable
public class RankingId implements java.io.Serializable {
	...
	public RankingId(int fkIdQuestion, int fkIdSection, int fkIdSurvey) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RankingId))
			return false;
		RankingId castOther = (RankingId) other;
